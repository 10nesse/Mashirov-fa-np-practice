...
def send_receive_client_message(client_connection, client_ip_addr):
    ...
    print(Fore.GREEN + f"{client_name} присоединился к чату." + Style.RESET_ALL)
    ...
    # Client is leaving
    print(Fore.RED + f"{client_name} покинул чат." + Style.RESET_ALL)
...
def start_server():
    ...
    server.listen(5)
    print(f"Сервер запущен на порте {HOST_PORT}...")
